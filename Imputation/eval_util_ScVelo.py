...
def evaluate(adata, cluster_edges, k_cluster, k_velocity, x_emb="X_umap", verbose=True):
    ...
    trans_probs = cross_boundary_scvelo_probs(adata, k_cluster, cluster_edges, 'velocity_graph', True)
    ...
    # In-cluster Coherence Score.
    ic_scvelo_coh = in_cluster_scvelo_coh(adata, k_cluster, 'velocity_confidence', True)
    # In-Cluster Confidence Score.
